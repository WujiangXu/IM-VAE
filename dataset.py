...
if __name__ == '__main__':
    datasetTrain = DualDomainSeqDatasetC2DSR(seq_len=20,view_len=100,isTrain=True,neg_nums=99,long_length=7,pad_id=111111,csv_path="dataset/cloth_sport_train_updated.csv")
